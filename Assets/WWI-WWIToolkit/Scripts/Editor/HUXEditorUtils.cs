...
namespace WWIToolkit.Unity.Editor
{
    public class HUXEditorUtils
    {
        ...
        public readonly static Color ObjectColor = new Color(0.87f, 0.94f, 1f);
        public readonly static Color ObjectColorEmpty = new Color(0.65f, 0.7f, 0.7f);
        ...
        public static T CreateProfile<T>(Type profileType) where T : ButtonProfile
        {
            ...
            {
                UnityEngine.Debug.LogError("Couldn't create profile of type " + profileType.Name);
            }
            return asset;
        }
        ...
        {
            ProfileInspector profileEditor = (ProfileInspector)UnityEditor.Editor.CreateEditor(profile);
        ...
        public static string MaterialPropertyName(string property, Material mat, ShaderUtil.ShaderPropertyType type, bool allowNone = true, string defaultProperty = "_Color", string label = "")
        {
            ...
            if (mat != null)
            {
                ...
                int newPropIndex = EditorGUILayout.Popup(type.ToString() + label, selectedPropIndex, props.ToArray());
                if (allowNone) {
        ...
        public static GameObject AddToScene(string prefabPath, bool ignoreAlreadyInScene = true)
        {
            ...
            if (prefab != null)
            {
                ...
                {
                    UnityEngine.Debug.LogWarning("Instance already exits in the scene: " + prefabPath);
                }
            }
            else
            {
                UnityEngine.Debug.LogError("Could not load prefab: " + prefabPath);
            }
