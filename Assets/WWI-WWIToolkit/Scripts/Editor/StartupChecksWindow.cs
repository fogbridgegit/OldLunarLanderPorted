...
namespace WWIToolkit.Unity.Editor
{
    public class StartupChecksWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("In order for the icon components included in this package to function correctly, you will need to download and install the '" +  ButtonIconProfileFont.DefaultUnicodeFont + "' icon font.", EditorStyles.wordWrappedLabel);
