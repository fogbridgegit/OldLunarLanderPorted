    ...
    public class HeadsUpDirectionIndicator : MonoBehaviour
    {
        ...
        private FrustumPlanes GetExitPlane(Vector3 targetPosition, Camera camera)
        {
            ...
            if (DebugDrawPointerOrientationPlanes)
            {
                ...
                UnityEngine.Debug.DrawLine(nearUpperLeft, nearLowerRight);
                UnityEngine.Debug.DrawLine(nearLowerRight, farUpperLeft);
                UnityEngine.Debug.DrawLine(farUpperLeft, nearUpperLeft);

                // Debug draw a triangle coplanar with 'e'
                UnityEngine.Debug.DrawLine(nearUpperRight, nearLowerLeft);
                UnityEngine.Debug.DrawLine(nearLowerLeft, farUpperRight);
                UnityEngine.Debug.DrawLine(farUpperRight, nearUpperRight);
            }
#endif
