...
using WWIToolkit.Unity.Cursors.CursorWidgets;
using WWIToolkit.Unity.Cursors;
...
namespace WWIToolkit.Unity.Focus
{
    public abstract class AFocuser : MonoBehaviour
	{
		...
		/// </summary>
		public WWIToolkit.Unity.Cursors.Cursor Cursor { get; protected set; }
        ...
        public WWIToolkit.Unity.Cursors.Cursor CursorPrefab;
        ...
        public void SetCursor(WWIToolkit.Unity.Cursors.Cursor  cursorPrefab)
		{
