...
namespace WWIToolkit.Unity.Core
{
    ...
    public class Veil : Singleton<Veil>
    {
        ...
        private void FixedUpdate()
        {
            ...
            UnityEngine.Debug.DrawLine(lastHeadPos, lastHeadPos + headMoveDirection * 10f, Color.Lerp(Color.red, Color.green, velP));
            UnityEngine.Debug.DrawLine(lastHeadPos, lastHeadPos + headVelocity, Color.yellow);
        }
