...
namespace WWIToolkit.Unity.Spatial.Solvers
{
    /// <summary>
    ...
    public abstract class Solver : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            {
                UnityEngine.Debug.LogError("No SolverHandler component found on " + name + " when UpdateLinkedTransform was set to true!  Disabling UpdateLinkedTransform");
