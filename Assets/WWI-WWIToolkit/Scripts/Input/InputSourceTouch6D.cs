...
namespace WWIToolkit.Unity.Input
{
    public class InputSourceTouch6D : InputSourceSixDOFBase
    {
        ...
        public override bool buttonSelectPressed
        {
            get
            {
                return InputSources.Instance.netMouse.Connected() ? (InputSources.Instance.netMouse.buttonSelectPressed || InputSources.Instance.netMouse.buttonLeftPressed) : (UnityEngine.Input.GetKey(KeyCode.UpArrow) || UnityEngine.Input.GetKey(KeyCode.LeftArrow));
            }
        }
        ...
        public override bool buttonMenuPressed
        {
            get
            {
                return InputSources.Instance.netMouse.Connected() ? InputSources.Instance.netMouse.buttonDownArrowPressed : UnityEngine.Input.GetKey(KeyCode.DownArrow);
            }
        }
